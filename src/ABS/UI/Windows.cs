...
namespace spaar.ModLoader.UI
{
  ...
  public class Windows
  {
    ...
    internal Windows()
    {
      ...
      {
        normal = { background = ModResource.GetTexture("ui_background-44px.png"), textColor = Elements.Colors.DefaultText },
        fontSize = 16,
      ...
      {
        normal = { background = ModResource.GetTexture("ui_background-dark.png"), textColor = Elements.Colors.DefaultText },
